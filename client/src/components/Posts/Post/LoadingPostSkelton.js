...
const LoadingPostSkelton = () => {
  return (
    <div className="max-w-md w-full rounded-md my-4 shadow-md shadow-black py-2 px-4 animate-pulse">
      <div className="flex items-center justify-center w-full bg-gray-300 rounded h-48">
        <svg
